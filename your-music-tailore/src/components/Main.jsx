...
export default function Main(){
    ...
    <div className="min-h-screen">
        <div className="flex items-center justify-center min-h-screen">
            <div className="w-[60vw] relative bottom-40">
                <div className="relative flex flex-col">
                    <div className="w-full backdrop-blur-sm bg-black/30 rounded-2xl border border-cyan-400/50 shadow-2xl shadow-cyan-500/20 mb-6 relative z-20">
                        <div id="genre-dropdown" className="relative flex flex-col w-full text-white items-start text-[12px] cursor-pointer">             
                            <h1 className="w-full flex justify-between focus:outline-1 genre-button w-full text-start p-4 bg-gradient-to-r from-pink-500/80 to-cyan-500/80 backdrop-blur-md rounded-t-2xl font-bold text-[14px] hover:from-[#6e00c3] hover:to-green-500 transition duration-300" 
                    ...
                    <div className="w-full top-12 backdrop-blur-sm bg-black/30 rounded-2xl border border-purple-400/50 shadow-2xl shadow-purple-500/20 -mt-12 relative z-10">
                        <div id="emotions-dropdown" className="relative flex flex-col w-full text-white items-start text-[20px] cursor-pointer">             
                            <h1 className="w-full flex justify-between focus:outline-1 emotions-button w-full text-start p-4 bg-gradient-to-r from-purple-500/80 to-pink-500/80 backdrop-blur-md rounded-t-2xl font-bold text-[14px] hover:from-[#6e00c3] hover:to-green-500 transition duration-300" 
                        ...
                        <div className="p-3">
                            <div className="flex flex-col w-full justify-end">
                                <div className="flex gap-2">
                                    ...
                                    />
                                    <button
                                        onClick={()=>{addCustomEmotion(customEmotion)}}
                    ...
                    <div className="top-18 w-full backdrop-blur-sm bg-black/30 rounded-2xl border border-green-400/50 shadow-2xl shadow-green-500/20 relative z-0">
                            <div className="p-4 bg-gradient-to-r from-green-500/80 to-teal-500/80 backdrop-blur-md rounded-t-2xl">
                                <h2 className="font-bold text-[14px] text-white">🎤 SIMILAR ARTIST</h2>
                            </div>
                            ...
                            <div className="flex flex-wrap text-[18px] w-full justify-center border-solid">
                                ...
                                <div className="mt-3 text-[18px] py-4 px-5 from-green-500/80 to-teal-500/80 bg-gradient-to-r flex gap-2 rounded-full">
                                    ...
                                    <div onClick={()=>setSimilarArtist("")} className="text-[20px] cursor-pointer">×</div>
                                </div>}
                            </div>
